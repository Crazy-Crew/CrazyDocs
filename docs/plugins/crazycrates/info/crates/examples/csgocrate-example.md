---
id: crazycrates-csgocrate-example
title: CSGO Type
slug: /crazycrates/info/crates/examples/csgocrate
hide_title: false
...
sidebar_label: CSGOCrate Example
---
```yaml
Crate:
  # Type of crate -> CSGO/Casino/QuadCrate/QuickCrate/Roulette/CrateOnTheGo/FireCracker/Wonder/Wheel/War
  ...
  BroadCast: '%prefix%&6&l%player%&r &7is opening a &7&lBasic Crate.'
